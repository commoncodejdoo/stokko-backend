...
const organizations_repository_1 = require("../../data/organizations/organizations.repository");
const organizations_repository_2 = require("../../domain/organizations/organizations.repository");
...
exports.OrganizationsModule = OrganizationsModule = __decorate([
    (0, common_1.Module)({
        providers: [
            { provide: organizations_repository_2.OrganizationsRepository, useClass: organizations_repository_1.PrismaOrganizationsRepository },
