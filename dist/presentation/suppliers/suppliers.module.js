...
const suppliers_repository_1 = require("../../data/suppliers/suppliers.repository");
const suppliers_repository_2 = require("../../domain/suppliers/suppliers.repository");
...
exports.SuppliersModule = SuppliersModule = __decorate([
    (0, common_1.Module)({
        ...
        providers: [
            { provide: suppliers_repository_2.SuppliersRepository, useClass: suppliers_repository_1.PrismaSuppliersRepository },
