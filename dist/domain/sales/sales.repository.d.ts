...
export declare abstract class SalesRepository {
    abstract upsertShift(input: UpsertShiftInput, tx?: TxClient): Promise<Shift>;
    abstract findShiftById(id: string, currency: string, tx?: TxClient): Promise<Shift | null>;
    abstract findShiftWithSales(id: string, currency: string, tx?: TxClient): Promise<ShiftWithSales | null>;
    abstract listShifts(filter: ListShiftsFilter, currency: string, tx?: TxClient): Promise<PaginatedShifts>;
    abstract createSale(input: CreateSaleInput, currency: string, tx?: TxClient): Promise<Sale>;
